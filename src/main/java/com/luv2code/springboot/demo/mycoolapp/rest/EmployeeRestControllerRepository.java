...
public class EmployeeRestControllerRepository {

	private EmployeeService thEmployeeService;
	
	@Autowired
	public EmployeeRestControllerRepository(@Qualifier("employeeServiceRepository") EmployeeService thEmployeeService) {
